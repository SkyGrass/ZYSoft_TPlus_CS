...
using Chanjet.ZYSoft.CS.Interface;
using Ufida.T.EAP.Aop;
using Ufida.T.EAP.DataStruct.Context;
using System.Web;
using Ufida.T.EAP.Dal;

namespace Chanjet.ZYSoft.CS.UIP
{
    public class CSPage : IAppHandler
    {
        GenericController controller;
        ICS interfaceService;
        Label lblUserName;
        Label lbUserId;
        Label lbUserCode;
        public void AppEventHandler(object sender, AppEventArgs e)
        {
            ...
            interfaceService = ServiceFactory.getService<ICS>();
